...
namespace CompactCryptoGroupAlgebra
{
    ...
    public interface ICryptoGroupAlgebra<TScalar, TElement> where TScalar : notnull where TElement : notnull
    {
        ...
        /// <summary>
        /// Checks whether an input of group element type could be an element of the group, i.e.,
        /// it must be an element of the mathematical structure the group is defined in.
        ///
        /// Note that this does not necessarily mean that the element is safe to use
        /// as it could be member of a small subgroup or not produced by the groups generator.
        /// See <see cref="IsSafeElement" />.
        /// </summary>
        /// <param name="element">The group element type object to check.</param>
        /// <returns><c>true</c> if the given input is a potential group element.</returns>
        bool IsPotentialElement(TElement element);

        /// <summary>
        /// Checks whether an input of group element type is a safe element of the group.
        ///
        /// An element has to satisfy two conditions:
        /// - be an element of the mathematical structure the group is defined in (see <see cref="IsPotentialElement" />),
        /// - be of group order (to prevent subgroup attacks).
        /// </summary>
        /// <param name="element">The group element type object to check.</param>
        /// <returns><c>true</c> if the given input is a safe group element.</returns>
        /// <remarks>
        /// Note that an element is not required to be generated by the group
        /// generator to be considered safe as long as it is a member of the superstructure
        /// and its order is identical to the group order.
        /// </remarks>
        bool IsSafeElement(TElement element);
