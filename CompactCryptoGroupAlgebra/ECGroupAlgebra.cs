...
namespace CompactCryptoGroupAlgebra
{
    ...
    public class ECGroupAlgebra : CryptoGroupAlgebra<ECPoint>
    {
        ...
        /// </summary>
        /// <remarks>
        /// This method cannot leak sensitive information and thus no effort
        /// was made to make it side-channel resistant.
        /// </remarks>
        ...
        public override bool IsValid(ECPoint point)
        {
            ...
            if (_parameters.Cofactor > 1)
            {
                ECPoint checkPoint = MultiplyScalar(point, _parameters.Cofactor, GetBitLength(_parameters.Cofactor));
                if (checkPoint.IsAtInfinity)
                    return false;
            }
            return true;
        }
